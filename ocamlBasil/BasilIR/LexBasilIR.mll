...
let resword_table = Hashtbl.create 80
let _ = List.iter (fun (kwd, tok) -> Hashtbl.add resword_table kwd tok)
                  [("let", KW_let);("memory", KW_memory);("var", KW_var);("int", KW_int);("bool", KW_bool);("map", KW_map);("bv", KW_bv);("address", KW_address);("le", KW_le);("be", KW_be);("load", KW_load);("store", KW_store);("call", KW_call);("indirect", KW_indirect);("assume", KW_assume);("assert", KW_assert);("goto", KW_goto);("unreachable", KW_unreachable);("return", KW_return);("block", KW_block);("entry", KW_entry);("exit", KW_exit);("blocks", KW_blocks);("name", KW_name);("proc", KW_proc);("zero_extend", KW_zero_extend);("sign_extend", KW_sign_extend);("extract", KW_extract);("bvconcat", KW_bvconcat);("true", KW_true);("false", KW_false);("bvnot", KW_bvnot);("bvneg", KW_bvneg);("bvand", KW_bvand);("bvor", KW_bvor);("bvadd", KW_bvadd);("bvmul", KW_bvmul);("bvudiv", KW_bvudiv);("bvurem", KW_bvurem);("bvshl", KW_bvshl);("bvlshr", KW_bvlshr);("bvnand", KW_bvnand);("bvnor", KW_bvnor);("bvxor", KW_bvxor);("bvxnor", KW_bvxnor);("bvcomp", KW_bvcomp);("bvsub", KW_bvsub);("bvsdiv", KW_bvsdiv);("bvsrem", KW_bvsrem);("bvsmod", KW_bvsmod);("bvashr", KW_bvashr);("bvule", KW_bvule);("bvugt", KW_bvugt);("bvuge", KW_bvuge);("bvslt", KW_bvslt);("bvsle", KW_bvsle);("bvsgt", KW_bvsgt);("bvsge", KW_bvsge);("bveq", KW_bveq);("bvneq", KW_bvneq);("bvult", KW_bvult);("intadd", KW_intadd);("intmul", KW_intmul);("intsub", KW_intsub);("intdiv", KW_intdiv);("intmod", KW_intmod);("inteq", KW_inteq);("intneq", KW_intneq);("intlt", KW_intlt);("intle", KW_intle);("intgt", KW_intgt);("intge", KW_intge);("booleq", KW_booleq);("boolneq", KW_boolneq);("booland", KW_booland);("boolor", KW_boolor);("boolimplies", KW_boolimplies);("boolequiv", KW_boolequiv);("intneg", KW_intneg);("boolnot", KW_boolnot)]
