...
and userIdent = UserIdent of ((int * int) * string)
...
and declaration =
 ...
 | ProgDecl of attrDefList * thrSpecDecl list
...
and attrDefList =
   AttrDefListSome of beginRec * attributeItem list * endRec
 | AttrDefListEmpty
...
and procDef =
   ProcedureDecl of procSig * attrDefList
 | ProcedureDef of procSig * attrDefList * beginList * block list * endList
